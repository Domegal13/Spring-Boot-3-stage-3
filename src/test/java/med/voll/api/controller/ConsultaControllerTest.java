...
class ConsultaControllerTest {
    ...
    @Test
    @DisplayName("deberia retornar estado http 200 cuando los datos ingresados sean válidos")
    @WithMockUser
    void agendarEscenario2() throws Exception {
        ...
        var response = mvc.perform(post("/consultas")
                ...
                .content(agendarConsultaJacksonTester.write(new DatosAgendarConsulta(2l, 2l, fecha, especialidad)).getJson())
